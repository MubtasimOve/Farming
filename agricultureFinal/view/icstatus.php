...
<html>
    ...
    <body>
        ...
        <fieldset style="width:82.5%">
            ...
            <form action="../controller/icstatussupdator.php" method="post">
                <table>
                    ...
                    <tr>
                        <td>Status: </td>
                        <td><input type="radio" name="status" value="Healthy">Healthy
                        <input type="radio" name="status" value="Unhealthy">Unhealthy</td>
                    </tr>
